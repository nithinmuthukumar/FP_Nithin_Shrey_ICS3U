...
#background
        self.backx,self.backy=4,0#which part of the background is blit
    ...
    def run(self):
        ...
        if link.rect.collidepoint(230,125) and (g.backx,g.backy)==(3,2):
            ...
            blitback()
        if link.rect.collidepoint(420,676) or link.rect.collidepoint(450,676) and (self.backx,self.backy)==(-1,0):
...
class enemy(gameobj):
    ...
    def itemdrop(self):
         itemdrop=choice(["rupee","heart","bomb","arrow"])
...
class wall(sprite.Sprite):
    def __init__(img,rectangle,location,br):
        g.wallsprites.add(self)
        self.image=img
        self.location=location
        self.rect=(rectangle)
        self.bre
    def block(self):
        if link.checkcollide(wallsprites):
            return False
        return True
...
#ui
redrupee=[imageload(("images/items/redRupee.png"))]
...
def drawminmap():
    ...
    draw.circle(g.screen,(255,0,0),(linkmappos[0]+575,linkmappos[1]+545),3)
...
regbullet = sentrybullet(150,50,700,(2,0),7)
homingbullet = sentrybullet(150,50,700,(2,0),7,True)
regbullet = sentrybullet(250,50,700,(2,0),7)
homingbullet = sentrybullet(250,50,700,(2,0),7,True)
regbullet = sentrybullet(550,50,700,(2,0),7)
homingbullet = sentrybullet(550,50,700,(2,0),7,True)
regbullet = sentrybullet(650,50,700,(2,0),7)
homingbullet = sentrybullet(650,50,700,(2,0),7,True)
regbullet = sentrybullet(50,50,700,(2,0),7)
homingbullet = sentrybullet(50,50,700,(2,0),7,True)
